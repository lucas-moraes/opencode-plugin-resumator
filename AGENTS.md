...
- `npm run release` — runs tests, bumps the patch version (`npm version patch`), and pushes with tags, triggering the GitHub Actions `publish` workflow (`.github/workflows/publish.yml`).
